  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col justify-between h-full">
      ...
      <div className="px-5 pb-5">
        <Link 
          href={`/bazares/${bazar.slug}`}
          className="block w-full py-2.5 bg-[#1A7A52] text-white font-semibold text-sm rounded-lg hover:bg-[#156a46] transition-colors text-center shadow-sm hover:shadow"
        >
          Ver detalles
        </Link>
      </div>
