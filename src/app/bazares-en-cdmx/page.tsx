      ...
      <header className="bg-white border-b border-gray-100 pt-16 pb-12 px-6">
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          <div className="text-lg text-gray-600 leading-relaxed font-medium space-y-4">
            ...
            <p>
              Ya sea que busques renovar tu clóset con prendas únicas de segunda mano (*slow fashion*), comprar piezas de diseño independiente mexicano o simplemente pasar una tarde agradable apoyando a marcas locales y emprendedores, en nuestro **directorio actualizado** encontrarás las fechas, horarios y ubicaciones exactas de los próximos eventos en la capital. Si quieres hacer planes inmediatos, revisa los <Link href="/bazares-este-fin-de-semana" className="text-[#1A7A52] hover:underline font-bold">bazares este fin de semana</Link>. También puedes explorar <Link href="/bazares-en-estado-de-mexico" className="text-primary hover:underline font-bold">bazares en Estado de México</Link> si buscas eventos cerca de CDMX.
            </p>
          </div>
        </div>
      </header>
